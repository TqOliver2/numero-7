...
void ImprimirValores(IEnumerable<Libro> listalibros) //metodo para imprimir los valores en consola
{
...
void ImprimirGrupo(IEnumerable<IGrouping<int, Libro>> listalibros)
{
...
void ImprimirDiccionario(ILookup<char, Libro> listalibros, char letra)
{
    Console.WriteLine("{0, -60} {1, 15} {2, 15}\n", "Titulo", "N. PAginas", "Fecha de publicacion");
